...
ASSETS += [
    ...
    {"symbol": "SMCI", "name": "Super Micro Computer", "category": "Stock"},
    ...
    {"symbol": "MELI", "name": "MercadoLibre", "category": "Stock"},
    {"symbol": "LULU", "name": "Lululemon", "category": "Stock"},
    {"symbol": "RBLX", "name": "Roblox", "category": "Stock"},
    {"symbol": "HOOD", "name": "Robinhood", "category": "Stock"},
    {"symbol": "SOFI", "name": "SoFi Technologies", "category": "Stock"},
    {"symbol": "RIVN", "name": "Rivian", "category": "Stock"},
    {"symbol": "LCID", "name": "Lucid Group", "category": "Stock"},
    {"symbol": "TEAM", "name": "Atlassian", "category": "Stock"},
]
